...
System.register(['@angular/core', './abstract.component', './dnd.config', './dnd.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var SortableContainer, SortableComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            SortableContainer = (function (_super) {
            ...
            exports_1("SortableContainer", SortableContainer);
            SortableComponent = (function (_super) {
            ...
            exports_1("SortableComponent", SortableComponent);
        }
    }
});
