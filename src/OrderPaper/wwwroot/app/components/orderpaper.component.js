System.register(['@angular/core', '@angular/router', '../models/orderpaper', '../services/app.services', './base.component', '../directives/ng2-bs3-modal/ng2-bs3-modal', './sections/motion.section.component', '../models/section'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, orderpaper_1, app_services_1, base_component_1, ng2_bs3_modal_1, motion_section_component_1, section_1;
    var OrderPaperComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            OrderPaperComponent = (function (_super) {
            ...
            exports_1("OrderPaperComponent", OrderPaperComponent);
        }
    }
});
