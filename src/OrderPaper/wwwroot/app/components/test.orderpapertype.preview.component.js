System.register(['@angular/core', './base.component', '../models/ordertype'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, base_component_1, ordertype_1;
    var TestOrderPaperTypePreviewComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            TestOrderPaperTypePreviewComponent = (function (_super) {
            ...
            exports_1("TestOrderPaperTypePreviewComponent", TestOrderPaperTypePreviewComponent);
        }
    }
});
